    ...
    return (
        <div>
            {flash.success && visible && (
                <div className="mt-8 flex items-center justify-between bg-green-500 rounded w-full">
            ...
            {(flash.error || numOfErrors > 0) && visible && (
                <div className="mt-8 flex items-center justify-between bg-red-500 rounded w-full">
                    <div className="flex items-center">
                        <IconDanger />
                        <div className="py-4 text-white text-sm font-medium">
